...
import { FileText, Download, Calendar, TrendingUp, Users, Package, Clock } from "lucide-react"
              ...
              <tbody>
                <tr className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-gray-900">Envíos Enero 2024</span>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-gray-700">Mensual</td>
                  <td className="py-4 px-4 text-gray-700">2024-01-15 14:30</td>
                  <td className="py-4 px-4 text-gray-700">2.4 MB</td>
                  <td className="py-4 px-4">
                ...
                <tr className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-2">
                      <FileText className="w-4 h-4 text-logistics-primary" />
                      <span className="font-medium text-gray-900">Clientes VIP</span>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-gray-700">Análisis</td>
                  <td className="py-4 px-4 text-gray-700">2024-01-14 09:15</td>
                  <td className="py-4 px-4 text-gray-700">1.8 MB</td>
                  <td className="py-4 px-4">
                    <Button size="sm" variant="ghost" className="text-blue-600 hover:text-blue-800">
                      <Download className="w-4 h-4" />
                    </Button>
                ...
                <tr className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-2">
                      <FileText className="w-4 h-4 text-logistics-primary" />
                      <span className="font-medium text-gray-900">Retrasos Semana 2</span>
                    </div>
                  </td>
                  <td className="py-4 px-4 text-gray-700">Semanal</td>
                  <td className="py-4 px-4 text-gray-700">2024-01-13 16:45</td>
                  <td className="py-4 px-4 text-gray-700">956 KB</td>
                  <td className="py-4 px-4">
                    <Button size="sm" variant="ghost" className="text-blue-600 hover:text-blue-800">
                      <Download className="w-4 h-4" />
                    </Button>
