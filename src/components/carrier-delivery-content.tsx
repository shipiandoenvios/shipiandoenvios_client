              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Badge className="bg-blue-500 text-white">{selectedPackage.priority}</Badge>
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Select value={deliveryStatus} onValueChange={setDeliveryStatus}>
                    ...
                    <SelectContent>
                      <SelectItem value="absent">Destinatario ausente</SelectItem>
                      <SelectItem value="wrong-address">Dirección incorrecta</SelectItem>
                      <SelectItem value="refused">Paquete rechazado</SelectItem>
                      <SelectItem value="no-access">Sin acceso al edificio</SelectItem>
