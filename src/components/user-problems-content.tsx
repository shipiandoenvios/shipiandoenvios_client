    ...
    <div className="max-w-4xl mx-auto space-y-8">
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div>
            ...
            <Select value={problemType} onValueChange={setProblemType}>
              ...
              <SelectContent>
                <SelectItem value="not-delivered">No fue entregado</SelectItem>
                <SelectItem value="damaged">Paquete dañado</SelectItem>
                <SelectItem value="wrong-address">Dirección incorrecta</SelectItem>
                <SelectItem value="delayed">Retraso en entrega</SelectItem>
      ...
      <Card className="border-0 shadow-lg bg-logistics-primary text-white">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-white/80 mb-4">Contacta con nuestro soporte 24/7</p>
          <div className="text-2xl font-bold">0800-SHIPIANDO</div>
        </CardContent>
      </Card>
    </div>
  )
