    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <Card className="border-0 shadow-lg bg-logistics-primary text-white">
        <CardContent className="p-6 text-center">
          <Badge className="bg-white text-logistics-primary mb-4">Cliente Premium</Badge>
          <h2 className="text-2xl font-bold mb-2">¡Bienvenida, María!</h2>
          <p className="text-white/80">Miembro desde Enero 2021 • 47 paquetes recibidos</p>
        </CardContent>
      </Card>
